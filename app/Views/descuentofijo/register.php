                ...
                <div class="card-action center-align">
                    <div class="card">
                        <div class="card-content">
                            <span class="card-title center-align">Registrar descuento fijo</span>
                            <br>
                            ...
                            <form action="<?= base_url('/descuentofijo/register') ?>" method="post">
                                ...
                                <div class="input-field">
                                    <input id="porcentaje" type="text" name="porcentaje" class="validate">
