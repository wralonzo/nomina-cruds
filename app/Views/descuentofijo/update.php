                ...
                <div class="card-action center-align">
                    <div class="card">
                        <div class="card-content">
                            <span class="card-title center-align">Actualizar descuento fijo</span>
                            <br>
                            <form action="<?= base_url('/descuentofijo/update/' . $data['id']) ?>" method="post">
                                ...
                                <div class="input-field">
                                    <input id="porcentaje_comision" type="text" name="porcentaje" value="<?= $data['porcentaje']  ?>" required>
