...
class SalarioController extends ResourceController
{
    public function register()
    {
        ...
        try {
            ...
            if (!$this->request->getPost()) {
                return view('layout/header') . view('salarios/register', ['empleado' => $empleado]) . view('layout/footer');
            }

            $data = $this->request->getPost();
            $data['empleado'] = $empleado;
            $userModel = new HistorialSalarioModel();
            $userModel->save($data);
    ...
    {
        try {
            $model = new HistorialSalarioModel();
            $session = session();
            if (!$this->request->getVar()) {
                ...
                $modeldeptos = new HistorialSalarioModel();
                $deptos = $modeldeptos->findAll();
                return view('layout/header') . view('salarios/update', ['data' => $user, 'deptos' => $deptos]) . view('layout/footer');
            }
